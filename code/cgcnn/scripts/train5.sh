...
python main.py --delete --seed --dims 2 --optim Adam --wd 0.0001 --train-ratio 0.6 --val-ratio 0.2 --test-ratio 0.2 --epochs 1000 --lr 0.0005 --batch-size 4 --id 103 --atom-fea-len 64 --n-conv 4 --h-fea-len 128 --n-h 1 --n-o 1 --train plqy --finetune-auto --fold 5 data/plqy
