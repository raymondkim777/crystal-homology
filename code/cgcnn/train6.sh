...
python main.py --delete --seed --dims 2 --optim Adam --wd 0.0001 --train-ratio 0.6 --val-ratio 0.2 --test-ratio 0.2 --epochs 100 --lr 0.008 --batch-size 4 --id 104 --atom-fea-len 64 --n-conv 4 --h-fea-len 128 --n-h 1 --n-o 1 --train plqy --freeze --finetune-auto --fold 5 data/plqy
